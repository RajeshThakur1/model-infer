import logging
from app.middlewares.contextmiddlewares import get_request_id
import os
# from app.utilities import constants


def get_logger(name,level=logging.INFO,file_name="/tmp/logs/model-inferencing-module.log"):
...
class TwiqLogger(logging.LoggerAdapter):
